    ...
    return (
        <div className='pop-page-master-container'>
            <div className='pop-page-cover-image-container'>
                <img src="https://images.unsplash.com/photo-1592685530337-c2d52665a642?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" className='pop-page-cover-image' />
            ...
            <div className='pop-page-song-list-master-container'>
                <div className='hip-hop-page-song-list-header-container'>

                    <div className='pop-page-song-list-header-container-text'>Hip Hop Playlist</div>
                ...
                <div className='hip-hop-page-song-list-master-container-2'>
                    <div>
                        {
                                ...
                                if(index === 0){
                                    ...
                                    return (
                                        <Link to={item.link} target="_blank" className="remove-link-style">
                                            <div className='hip-hop-page-song-list-column-container-2'>
