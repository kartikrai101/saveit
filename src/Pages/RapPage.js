    ...
    return (
        <div className='pop-page-master-container'>
            <div className='pop-page-cover-image-container'>
                <img src="https://images.unsplash.com/photo-1585794034386-a80c6ec1f4de?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" className='pop-page-cover-image' />
            ...
            <div className='pop-page-song-list-master-container'>
                <div className='rap-page-song-list-header-container'>

                    <div className='pop-page-song-list-header-container-text'>Rap Playlist</div>
                ...
                <div className='rap-page-song-list-master-container-2'>
                    <div>
                        {
